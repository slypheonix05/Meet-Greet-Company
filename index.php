...
<html lang="en">
    ...
    <style>
    	header.masthead {
		  background: url(img/conference1.jpg);
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="./">Meet&Greet Company</a>
    ...
    <div class="modal-dialog modal-md" role="document">
      ...
      <div class="modal-footer">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Meet&Greet Company | <a href="#" target="_blank">LOG IN </a></div></div>
        </footer>
